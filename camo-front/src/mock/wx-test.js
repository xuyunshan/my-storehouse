const res = {
  pageName: 'wx-test-gen',
  shareImg_square: 'https://www.linkedin-event.com/image/onboarding-guide/share.jpeg',
  shareImg_Rect1: 'https://www.linkedin-event.com/image/guidebookHome/share.png',
  shareImg_Rect2: 'https://www.linkedin-event.com/image/guidebookHome/share.png',
  title_page: '向往的行业 领英海外专场',
  title_share_wx: '海外专场',
  title_share_zephyr: '领英最新上线「向往的行业 领英海外专场」。',
  title_share_miniprogram: '海外专场',
  description_share_miniprogram: '领英海外专场',
  description_share_wx: '向往的行业 领英海外专场',
  render: {
    layouts: [
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs01.473b95a3.png',
        id: 2,
        active: false,
      },
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs02.7905b23e.png',
        id: 3,
        active: false,
      },
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs03.342cba65.png',
        id: 4,
        active: false,
      },
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs06.c57b3ab7.png',
        id: 6,
        active: false,
      },
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs04.d68913a7.png',
        id: 5,
        active: false,
      },
      {
        src: 'https://linkedin-event.com/campaign/assets/img/cjlxs05.06059636.png',
        id: 1,
        active: false,
      },
    ],
    hotAreas: [
      {
        style: { left: '222', width: '126', height: '96', top: '933' },
        id: 1,
      ...
      },
      {
        ...
        id: 2,
        link: 'https://www.linkedin.com/in/wayneshiong/',
      ...
      },
      {
        ...
        id: 4,
        link: 'https://www.linkedin.com/in/wuchudavid/',
      ...
      },
      {
        ...
        id: 5,
        link: 'https://www.linkedin.com/in/ceciliazhouchen/',
    ...
    fixedBottoms: [
      {
        style: { left: '0', width: '100%', height: '250', bottom: '0', zIndex: '1000' },
        id: 4,
        bgStyle: 'https://linkedin-event.com/campaign/assets/img/mentorbanner.522efb1e.png',
    ...
    swipers: [
      {
        ...
        elements: [
          {
            id: 6,
            src: 'https://linkedin-event.com/campaign/assets/img/scarlet.9fe753ca.png',
    ...
    imagesToSave: [
      {
        ...
        id: 1,
        src: 'https://linkedin-event.com/campaign/assets/img/code.b70519d0.png',
        active: false,
      },
    ],
    textRules: [
      {
        ...
        entrance: {
          ...
          bgStyle: 'https://linkedin-event.com/campaign/assets/img/code.b70519d0.png',
    ...
    vScrolls: [
      //   {
      //     id: 1,
      //     style: { width: '654', height: '315', left: '64', top: '2269', zIndex: 500 },
      //     active: false,
      //     elements: [
      //       {
      //         id: 1,
      ...
      //           marginRight: '20',
      //         },
      //         bgStyle: 'https://linkedin-event.com/campaign/assets/img/scarlet.9fe753ca.png',
      //       },
      //       {
      //         id: 2,
      //         style: {
