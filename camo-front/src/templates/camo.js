...
const Camo = ({ pageContext }) => {
  const { layoutsData } = pageContext;
  const EVENT_HTTP_PREFIX = 'https://www.linkedin-event.com';
  ...
  return (
    <div className="wrapper" style={{ backgroundColor: layoutsData.backgroundColor }}>
      <Helmet>
        ...
        <style type="text/css">{`a[href^="https://www.cnzz.com"] {display: none;} html {font-size: 10vw; max-width: 750px;} body {margin: 0;} @media screen and (min-width: 750px){html {font-size: 75px}}`}</style>
        ...
        <script src="https://s4.cnzz.com/z_stat.php?id=1277901282&web_id=1277901282"></script>
